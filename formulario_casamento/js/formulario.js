...
form.addEventListener("submit", async (event) => {
    ...
    pedidos.push(pedido);
    SIGACRC.salvarPedidos(pedidos);
    localStorage.setItem(SIGACRC.chaves.ultimoProtocolo, pedido.protocolo);

    exibirMensagemFormulario(`Pedido enviado com sucesso. Protocolo gerado: ${pedido.protocolo}`, "sucesso");
